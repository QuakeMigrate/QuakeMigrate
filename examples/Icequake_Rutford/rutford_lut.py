...
grid_spec = {"ll_corner": [-84.14853353566141, -78.18825429331356, -350.],
...
lut = compute_traveltimes(grid_spec, stations, method="homogeneous", vp=3841,
                          vs=1970, log=True, save_file=lut_out)
