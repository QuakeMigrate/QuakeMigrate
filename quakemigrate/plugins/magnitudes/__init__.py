"""
The :mod:`quakemigrate.plugins.magnitudes` extension module handles the calculation of
local magnitudes from Wood-Anderson simulated waveforms.

.. warning:: The magnitudes modules are an ongoing work in progress. We hope to\
