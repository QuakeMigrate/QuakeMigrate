...
class ScanmSEED:
    ...
    def __init__(self, run: Run, continuous_write: bool, sampling_rate: int) -> None:
    ...
    def _data2int(self, data: np.ndarray, factor: float) -> np.ndarray[int]:
        """
...
@util.timeit()
def read_scanmseed(
    run: Run, starttime: UTCDateTime, endtime: UTCDateTime, pad: float, ucf: float
