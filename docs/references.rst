...
A more comprehensive set of references can be found in :ref:`Smith et al., 2020 <Smith-2020>`
...
.. _Smith-2020:
    ...
    Smith, J., Winder, T., Bacon, C., Hudson, T., Greenfield, T., White, R.S., Drew, J., (Submitted). QuakeMigrate: a Python package for earthquake detection and location using waveform stacking. Seismological Research Letters.
