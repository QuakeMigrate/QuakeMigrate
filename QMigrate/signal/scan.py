...
class SeisScan(DefaultSeisScan):
    ...
    def _gaussian_trigger(self, onset, phase, start_time, p_arr, s_arr, ptt, stt):
        """
        Fit a Gaussian to the onset function in order to make a time pick.

        Uses knowledge of approximate trigger index, the short-term average
